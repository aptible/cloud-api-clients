...
module CloudApiClient
  class Data
    ...
    def list_invalid_properties
      ...
      if @action_output.nil?
        invalid_properties.push('invalid value for "action_output", action_output cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @action_output.nil?
      _any_of_found = false
    ...
    def hash
      [error, terraform_init, terraform_plan, terraform_apply, terraform_plan_failures, terraform_apply_failures, action_output, action_errors].hash
    end
