...
export class OperationsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async operationGet(operationId: string, organizationId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'operationId' is not null or undefined
        if (operationId === null || operationId === undefined) {
            throw new RequiredError("OperationsApi", "operationGet", "operationId");
        }


        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("OperationsApi", "operationGet", "organizationId");
        }
     ...
     */
    public async operationUpdate(operationId: string, operationUpdate: OperationUpdate, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'operationId' is not null or undefined
        if (operationId === null || operationId === undefined) {
            throw new RequiredError("OperationsApi", "operationUpdate", "operationId");
        }


        // verify required parameter 'operationUpdate' is not null or undefined
        if (operationUpdate === null || operationUpdate === undefined) {
            throw new RequiredError("OperationsApi", "operationUpdate", "operationUpdate");
        }
...
export class OperationsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to operationUpdate
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async operationUpdate(response: ResponseContext): Promise<any > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
