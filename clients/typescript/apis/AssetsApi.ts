...
export class AssetsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async getAssetsApiV1OrganizationsOrganizationIdEnvironmentsEnvironmentIdAssetsGet(environmentId: string, organizationId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'environmentId' is not null or undefined
        if (environmentId === null || environmentId === undefined) {
            throw new RequiredError("AssetsApi", "getAssetsApiV1OrganizationsOrganizationIdEnvironmentsEnvironmentIdAssetsGet", "environmentId");
        }


        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("AssetsApi", "getAssetsApiV1OrganizationsOrganizationIdEnvironmentsEnvironmentIdAssetsGet", "organizationId");
        }
