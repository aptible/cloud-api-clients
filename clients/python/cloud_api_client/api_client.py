...
from cloud_api_client import rest
from cloud_api_client.configuration import Configuration
from cloud_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from cloud_api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.action_create  # this is an instance of the class Endpoint
        api_instance.action_create()  # this invokes api_instance.action_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.action_create.callable or self.callable in this class
