...
class OrganizationInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "baa_status", "contact_details", "aws_ou", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "baa_status", "contact_details", "aws_ou", ], str]):
