...
class OperationUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "data", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> 'OperationStatus': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "data", ], str]):
