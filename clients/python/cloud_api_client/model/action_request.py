...
class ActionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action_name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            parameters (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, action_name, *args, **kwargs):  # noqa: E501
        """ActionRequest - a model defined in OpenAPI
