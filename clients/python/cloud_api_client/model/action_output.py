...
class ActionOutput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'asset': (AssetOutput,),  # noqa: E501
            'operation': (OperationOutput,),  # noqa: E501
            'parameters': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'output': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, action_name, asset, operation, *args, **kwargs):  # noqa: E501
        """ActionOutput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            output ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, action_name, asset, operation, *args, **kwargs):  # noqa: E501
        """ActionOutput - a model defined in OpenAPI
