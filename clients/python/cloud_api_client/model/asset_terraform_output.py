...
class AssetTerraformOutput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, sensitive, structure, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, sensitive, structure, *args, **kwargs):  # noqa: E501
        """AssetTerraformOutput - a model defined in OpenAPI
